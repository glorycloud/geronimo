...
public class POP3ConnectionPool {
     ...
     * @exception MessagingException
     */
    public POP3Connection createPoolConnection() throws MessagingException {
    ...
    public synchronized POP3Connection createFreshConnection() throws MessagingException
    {
    	if (availableConnection != null) {
            availableConnection.close(); 
            availableConnection = null; 
