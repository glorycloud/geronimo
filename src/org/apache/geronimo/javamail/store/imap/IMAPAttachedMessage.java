...
public class IMAPAttachedMessage extends IMAPMessage {
     ...
     */
    public IMAPAttachedMessage(IMAPMessage parent, String section, IMAPEnvelope envelope, IMAPBodyStructure bodyStructure) throws MessagingException {
        super((IMAPFolder)parent.getFolder(), parent.store, parent.getMessageNumber(), parent.getSequenceNumber());
        this.parent = parent;
